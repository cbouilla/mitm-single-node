...
struct CollisionCandidate {
	u64 i;                  /* mixing function version; service_collision asserts it is the round's */
	...
	u64 len1_maybe;         /* ... and its length; 0 == saturated in the dictionary, walk_nolen1 re-walks it */
};
