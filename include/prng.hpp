...
/* Implements a hash function that produces 8-bit digest from a 64-bit number
 * based on a random permutation that is generated within this class. 
 */
class PearsonHash{
  
  std::vector<uint8_t>T = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
